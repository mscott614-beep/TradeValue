...
__export(generate_exports, {
  ...
  maybeRegisterDynamicMiddlewareTools: () => maybeRegisterDynamicMiddlewareTools,
...
async function normalizeMiddleware(registry, middlewareList) {
  ...
  for (let i = 0; i < middlewareList.length; i++) {
    ...
    if (typeof middleware === "function") {
      ...
      const wrappedDef = (0, import_middleware.generateMiddleware)(
...
async function generate(registry, options) {
  ...
  const resolvedMiddleware = await (0, import_middleware.resolveMiddleware)(registry, middlewareRefs);
