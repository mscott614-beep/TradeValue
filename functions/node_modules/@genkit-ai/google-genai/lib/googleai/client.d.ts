...
declare const tracingHooks: {
    runInNewSpan: typeof runInNewSpan;
};
/**
...
export { TEST_ONLY, cancelInteraction, createInteraction, embedContent, generateContent, generateContentStream, getGoogleAIUrl, getInteraction, imagenPredict, listModels, tracingHooks, veoCheckOperation, veoPredict };
