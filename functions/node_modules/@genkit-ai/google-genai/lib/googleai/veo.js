...
const VeoConfigSchema = import_genkit.z.object({
  ...
  resolution: import_genkit.z.enum(["720p", "1080p", "4k"]).describe("Resolution of the output video.").optional(),
...
function listActions(models) {
  return models.filter(
    (m) => m.supportedGenerationMethods.includes("predictLongRunning") && isVeoModelName((0, import_utils2.modelName)(m.name))
...
function defineModel(name, pluginOptions) {
  ...
  return (0, import_plugin.backgroundModel)({
    ...
    configSchema: ref.configSchema,
    async start(request) {
      const apiKey = (0, import_utils2.calculateApiKey)(pluginOptions?.apiKey, void 0);
      const veoPredictRequest = {
        instances: [
          {
            prompt: (0, import_utils2.extractText)(request),
            image: (0, import_utils2.extractVeoImage)(request),
            video: (0, import_utils2.extractVeoVideo)(request)
          }
        ],
