...
function defineEmbedder(name, pluginOptions) {
  ...
  return (0, import_plugin.embedder)(
    ...
    async (request, _) => {
      const embedApiKey = (0, import_utils2.calculateApiKey)(
        pluginOptions?.apiKey,
        request.options?.apiKey
      );
      const embedVersion = request.options?.version || (0, import_utils2.extractVersion)(ref);
        ...
        request.input.map(async (doc) => {
          const response = await (0, import_client.embedContent)(
            ...
            embedVersion,
            {
              ...
              content: (0, import_converters.toGeminiMessage)({ role: "user", content: doc.content }),
