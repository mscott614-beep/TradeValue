...
function listActions(models) {
  return models.filter(
    (m) => m.supportedGenerationMethods.includes("predict") && isImagenModelName((0, import_utils2.modelName)(m.name))
        ...
        instances: [
          {
            ...
            image: (0, import_utils2.extractImagenImage)(request)
          }
        ],
        parameters: toImagenParameters(request)
      };
      const predictApiKey = (0, import_utils2.calculateApiKey)(
