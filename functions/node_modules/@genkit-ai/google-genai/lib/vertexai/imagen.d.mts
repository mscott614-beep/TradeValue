...
declare const ImagenTryOnConfigSchema: z.ZodObject<{
    ...
    safetySetting: z.ZodOptional<z.ZodEnum<["block_most", "block_some", "block_few", "block_fewest"]>>;
    storageUri: z.ZodOptional<z.ZodString>;
    outputOptions: z.ZodOptional<z.ZodObject<{
        mimeType: z.ZodOptional<z.ZodString>;
        compressionQuality: z.ZodOptional<z.ZodNumber>;
    }, "strip", z.ZodTypeAny, {
...
type ImagenTryOnConfigSchemaType = typeof ImagenTryOnConfigSchema;
type ImagenTryOnConfig = z.infer<ImagenTryOnConfigSchemaType>;
type ConfigSchemaType = ImagenConfigSchemaType | ImagenTryOnConfigSchemaType;
declare const KNOWN_MODELS: {
    readonly 'imagen-3.0-generate-002': ModelReference<ConfigSchemaType>;
    readonly 'imagen-3.0-generate-001': ModelReference<ConfigSchemaType>;
    readonly 'imagen-3.0-capability-001': ModelReference<ConfigSchemaType>;
    readonly 'imagen-3.0-fast-generate-001': ModelReference<ConfigSchemaType>;
    readonly 'imagen-4.0-fast-generate-001': ModelReference<ConfigSchemaType>;
    readonly 'imagen-4.0-generate-001': ModelReference<ConfigSchemaType>;
    readonly 'imagen-4.0-ultra-generate-001': ModelReference<ConfigSchemaType>;
    readonly 'virtual-try-on-001': ModelReference<ConfigSchemaType>;
};
type KnownModels = keyof typeof KNOWN_MODELS;
type ImagenModelName = KnownModels | `imagen-${string}` | `virtual-try-on-${string}`;
...
export { type ConfigSchemaType, type ImagenConfig, ImagenConfigSchema, type ImagenConfigSchemaType, type ImagenModelName, type ImagenTryOnConfig, ImagenTryOnConfigSchema, type ImagenTryOnConfigSchemaType, KNOWN_MODELS, type KnownModels, TEST_ONLY, defineModel, isImagenModelName, listActions, listKnownModels, model };
