...
function defineModel(name, clientOptions, pluginOptions) {
  ...
  return (0, import_plugin.backgroundModel)({
    ...
    async start(request) {
      ...
      return (0, import_converters.fromVeoOperation)(response, clientOpt);
    },
    async check(operation) {
      const checkClientOptions = (0, import_converters.toVeoClientOptions)(operation, clientOptions);
      ...
      return (0, import_converters.fromVeoOperation)(response, checkClientOptions);
    }
  });
}
const TEST_ONLY = {
