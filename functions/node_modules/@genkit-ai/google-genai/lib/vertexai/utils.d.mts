...
declare function shouldUseLegacyEndpoint(model: string): model is "lyria-002";
...
export { API_KEY_FALSE_ERROR, MISSING_API_KEY_ERROR, NOT_SUPPORTED_IN_EXPRESS_ERROR, type RequestClientOptions, TEST_ONLY, calculateApiKey, calculateRequestOptions, checkApiKey, checkSupportedResourceMethod, getApiKeyFromEnvVar, getDerivedOptions, shouldUseLegacyEndpoint };
