...
type EmbedderModelName = `${string}embedding${string}`;
...
export { type EmbedderModelName, type EmbeddingConfig, EmbeddingConfigSchema, type EmbeddingConfigSchemaType, KNOWN_MODELS, type KnownModels, TEST_ONLY, defineEmbedder, isEmbedderName, listKnownModels, model };
