import { MediaPart, JSONSchema, ModelReference, z, EmbedderReference } from 'genkit';
import { GenerateRequest } from 'genkit/model';
import { GenerateContentResponse, GenerateContentStreamResult } from './types.mjs';
...
declare function buildTraceMetadataInput(url: string, fetchOptions: RequestInit, traceOptions: {
    request?: unknown;
    model?: string;
    clientOptions?: {
        timeout?: number;
...
declare function isKnownKey<T extends object>(key: string | number | symbol, obj: T): key is keyof T;
/**
 ...
 */
declare function parseRetryAfterMs(value: string): number | undefined;
declare const TEST_ONLY: {
    aggregateResponses: typeof aggregateResponses;
};

export { TEST_ONLY, buildTraceMetadataInput, checkModelName, checkSupportedMimeType, cleanSchema, displayUrl, extractErrMsg, extractMedia, extractMediaArray, extractMimeType, extractText, extractVersion, getGenkitClientHeader, isKnownKey, modelName, parseRetryAfterMs, processStream, stringTruncator };
