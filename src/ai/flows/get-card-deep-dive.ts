...
export const CardDeepDiveSchema = z.object({
    ...
    investmentGrade: z.enum(['Strong Buy', 'Buy', 'Hold', 'Sell', 'Strong Sell']).describe('Sentiment based on price drift and liquidity.'),
    ...
    async (card) => {
        try {
            ...
            const prompt = `
                ...
                Output EXACTLY 100% valid JSON matching the schema.
            `;
            ...
            return {
                ...
                marketFloor,
                recentVelocity: velocitySummary,
                isGrounded: true
            };
